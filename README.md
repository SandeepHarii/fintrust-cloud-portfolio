...
* [Weekly Summaries](#weekly-summaries)
  ...
  * [Week 7 – Event-Driven Architecture, APIs & Serverless](#week-7--event-driven-architecture-apis--serverless)
...
The portfolio showcases practical work completed throughout the programme, covering AWS cloud architecture, Python development, SQL, data engineering, networking, security, APIs, serverless computing, event-driven architecture, analytics, streaming, machine learning, and supporting technical documentation.
...
The portfolio distinguishes between technologies that were **implemented**, **configured**, **designed**, **explored**, and **evaluated**. AWS services are not presented as deployed unless there is evidence that they were actually provisioned and used.
