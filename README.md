...
The portfolio showcases practical work completed throughout the programme, covering AWS cloud architecture, Python development, SQL, data engineering, networking, security, APIs, serverless computing, event-driven architecture, and supporting technical documentation.
